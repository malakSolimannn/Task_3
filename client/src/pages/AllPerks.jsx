...
export default function AllPerks() {
  ...
  // Load all perks initially
  useEffect(() => {
    loadAllPerks()
  }, [])

  // Auto-fetch when search or merchant changes (after initial load)
  useEffect(() => {
      ...
      <div className="card">
        <form onSubmit={handleSearch} className="space-y-4">
          ...
          <div className="flex gap-3 items-center">
            ...
            >
              <span className="material-symbols-outlined text-sm align-middle">search</span> Search
              Now
            </button>
            <button type="button" onClick={handleReset} className="btn">
              <span className="material-symbols-outlined text-sm align-middle">refresh</span> Reset
              Filters
            </button>
